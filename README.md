...
|⚠️|O jogo não tem enredo/objetivo|A jogabilidade é muito repetitiva porque ainda não tem alma, é apenas um jogo de esconde-esconde|Pensei em fazer um jogo de "roubo" mas com enredo "feminino". A garota vai a lugares para pegar itens e assim construir algo. Talvez focar em um estilo "cooperativo", mesmo que seja apenas em LAN ou até mesmo com controles duplos/tela dividida é interessante|-|Não resolvido|
|⚠️|O design do jogo está errado|Como era um projeto de Game Jam, a maioria dos aspectos importantes para torná-lo adequado para ideias de longo prazo está falha/irrecuperável da forma como foi deixado|Reimplementar, reescrever e gerenciar todo o design do jogo para melhor velocidade e qualidade de desenvolvimento|-|Não resolvido|
|⚠️|Sem HUD|O HUD está faltando para os jogadores|Criar HUD de interface do usuário|-|Não resolvido|
|⚠️|Sem rotas para tarefas/objetivos no jogo|O jogador fica desorientado sobre para onde ir, para onde olhar e o que fazer|Facilitar a navegação na área de registro de marcas e tornar o jogo mais fácil de jogar|-|Não resolvido|
|⚠️|Jogabilidade lenta, com média de 20 fps|O jogo é muito simples para ter um desempenho tão ruim|Melhorar o fluxo de trabalho de recursos, LOD e otimizações gerais|-|Não resolvido|
|⚠️|Sem sensação de "pego"|O jogador não tem noção do que o rodeia, nem sente a emoção de agir secretamente|Melhorar a interface do usuário, a IA ou o design geral dos níveis para que se veja mais do mapa -- a posição da câmera também pode ser um problema, talvez menos "isométrica"|-|Não resolvido|
|🛠️|IA muito burra|A IA não tem noção do ambiente|Melhorar até certo ponto|-|Não resolvido|
|🛠️|Experiência do usuário ruim (design de níveis)|Os jogadores não se importam em escapar do hotel... a trama principal não existe, você está apenas vagando e sendo perseguido|Desenvolver níveis melhores/diferentes pode resolver o problema|-|Não resolvido|
|🛠️|Implementação ruim de quebra-cabeças (funcionam, mas não são simples)|Tarefas repetitivas, "IDs" pouco claros e piadas sem graça|Talvez seja melhor criar quebra-cabeças dentro do jogo em vez de quebra-cabeças 2D e, nesse caso, tentar quebra-cabeças menos difíceis, já que o 2D não é mais o foco principal|-|Não resolvido|
|🛠️|Portas ainda funcionam após serem quebradas|O jogador ainda poderá interagir com as portas e provavelmente com os itens coletáveis, contanto que estejam por perto|Melhorar o sistema de itens/interação|-|Não resolvido|
|-|-|-|-|-|-|
